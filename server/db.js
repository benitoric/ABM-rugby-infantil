...
export async function migrar(pool) {
  ...
  // El carnet de obra social salió del checklist y entró la devolución del
  // DNI (el original viaja con el staff y se devuelve al volver). Es la
  // columna más nueva: hace de testigo en migracionesAplicadas.
